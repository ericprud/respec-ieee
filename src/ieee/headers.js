...
export const name = "ieee/headers";

const status2text = {
  PD: "Pre-Draft",
  WGD: "IEEE Work Group Draft",
  WGA: "IEEE Working Group Approved Draft",
  FD: "IEEE Final Deliverable",
};

const IEEEDate = new Intl.DateTimeFormat(["en-US"], {
  timeZone: "UTC",
  year: "numeric",
  month: "long",
  day: "2-digit",
...
export function run(conf) {
  ...
  conf.publishHumanDate = IEEEDate.format(conf.publishDate);
