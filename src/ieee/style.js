...
function createResourceHints() {
  ...
  const opts = [
    ...
    },
    {
      ...
      // href: "../../ericprud/respec-ieee/src/ieee/ieee.css",
...
function styleMover(linkURLs) {
  return exportDoc => {
    for (linkURL of linkURLs) {
      const style = exportDoc.querySelector(`head link[href="${linkURL}"]`);
      exportDoc.querySelector("head").append(style);
    }
  };
}
...
export function run(conf) {
  ...
  const ieeeStyleURL =
        "//raw.githubusercontent.com/ericprud/respec-ieee/ieee/src/ieee/ieee.css"
        // "../../ericprud/respec-ieee/src/ieee/ieee.css"
  ;
